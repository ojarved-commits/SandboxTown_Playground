...
ANT_FAST = MotionProfile(
    ...
    model="ant",
    base_speed=110.0,
    crawl_speed_min=45.0,
    lerp_alpha=0.10,
    wander_mix=0.55,
    inside_zone_retarget_p=0.05,
...
BIRD_GLIDE = MotionProfile(
    name="BIRD_GLIDE",
    model="ant",   # IMPORTANT: bird reuses ant engine
    base_speed=125.0,
    crawl_speed_min=40.0,
    lerp_alpha=0.04,
    wander_mix=0.90,
    inside_zone_retarget_p=0.02,
    orbit_impulse_p=0.06,
    orbit_strength_x=160,
    orbit_strength_y=120,
    commit_min=90,
    commit_max=160,
    edge_pause_ticks=20,
    edge_pause_cooldown=40,
    dwell_ramp_rate=1 / 420.0,
    dwell_ramp_cap=1.8,
    hysteresis_eps=0.18,
)
